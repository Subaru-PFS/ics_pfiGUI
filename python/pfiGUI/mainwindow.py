...
class PfiGUI(QWidget):
    def __init__(self, mainTree):
        ...
        self.labelLayout.addWidget(ValueGB('Temp1-1(C) ', self.actor.models['peb'], 'temps', 0, '{:g}'), 0, 0)
        self.labelLayout.addWidget(ValueGB('Temp1-2(C) ', self.actor.models['peb'], 'temps', 1, '{:g}'), 0, 1)
        self.labelLayout.addWidget(ValueGB('Temp1-3(C) ', self.actor.models['peb'], 'temps', 2, '{:g}'), 0, 2)
        self.labelLayout.addWidget(ValueGB('Temp1-4(C) ', self.actor.models['peb'], 'temps', 3, '{:g}'), 0, 3)
        self.labelLayout.addWidget(ValueGB('Temp1-5(C) ', self.actor.models['peb'], 'temps', 4, '{:g}'), 0, 4)
        self.labelLayout.addWidget(ValueGB('Temp1-6(C) ', self.actor.models['peb'], 'temps', 5, '{:g}'), 0, 5)
        self.labelLayout.addWidget(ValueGB('Temp1-7(C) ', self.actor.models['peb'], 'temps', 6, '{:g}'), 0, 6)
        self.labelLayout.addWidget(ValueGB('Temp2-1(C) ', self.actor.models['peb'], 'temps', 7, '{:g}'), 1, 0)
        self.labelLayout.addWidget(ValueGB('Temp2-2(C) ', self.actor.models['peb'], 'temps', 8, '{:g}'), 1, 1)
        self.labelLayout.addWidget(ValueGB('Temp2-3(C) ', self.actor.models['peb'], 'temps', 9, '{:g}'), 1, 2)
        self.labelLayout.addWidget(ValueGB('Temp2-4(C) ', self.actor.models['peb'], 'temps', 10, '{:g}'), 1, 3)
        self.labelLayout.addWidget(ValueGB('Temp2-5(C) ', self.actor.models['peb'], 'temps', 11, '{:g}'), 1, 4)
        self.labelLayout.addWidget(ValueGB('Temp2-6(C) ', self.actor.models['peb'], 'temps', 12, '{:g}'), 1, 5)
        self.labelLayout.addWidget(ValueGB('Temp2-7(C) ', self.actor.models['peb'], 'temps', 13, '{:g}'), 1, 6)
        self.labelLayout.addWidget(ValueGB('Temp3-1(C) ', self.actor.models['peb'], 'temps', 14, '{:g}'), 2, 0)
        self.labelLayout.addWidget(ValueGB('Temp3-2(C) ', self.actor.models['peb'], 'temps', 15, '{:g}'), 2, 1)
        self.labelLayout.addWidget(ValueGB('Temp3-3(C) ', self.actor.models['peb'], 'temps', 16, '{:g}'), 2, 2)
        self.labelLayout.addWidget(ValueGB('Temp3-4(C) ', self.actor.models['peb'], 'temps', 17, '{:g}'), 2, 3)
        self.labelLayout.addWidget(ValueGB('Temp3-5(C) ', self.actor.models['peb'], 'temps', 18, '{:g}'), 2, 4)
        self.labelLayout.addWidget(ValueGB('Temp3-6(C) ', self.actor.models['peb'], 'temps', 19, '{:g}'), 2, 5)
        self.labelLayout.addWidget(ValueGB('Temp3-7(C) ', self.actor.models['peb'], 'temps', 20, '{:g}'), 2, 6)
